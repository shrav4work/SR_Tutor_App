                ...
                public void onComplete(@NonNull Task<Location> task) {
                    ...
                    if(location != null){
                       ...
                       // ------------------------------------------------------------------------------------------
                        ...
                        final String url = "http://192.168.0.108:3000/api/location";
                                    ...
                                    public void onResponse(JSONObject response) {
                                        try {
                                            if(response.getBoolean("success")) {
                                                String email = response.getString("msg");
                                                Double latt =Double.parseDouble(response.getString("lat"));
                                                Double lonn =Double.parseDouble(response.getString("lon"));
                                                Log.i("locationret",email);
                                                double calcDistance  = distance(latt, lonn,location.getLatitude(),location.getLongitude());
